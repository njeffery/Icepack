...
! subroutine to set the column package internal parameters
      ...
      subroutine icepack_init_parameters(   &
         ...
         kice_in, ksno_in, min_area_in, min_mass_in, &
...
!-----------------------------------------------------------------------
      ...
      real(kind=dbl_kind), intent(in), optional :: &
         min_area_in,   & ! zap residual ice below this minimum area
         min_mass_in,   & ! zap residual ice below this minimum mass
...
!autodocument_end
      ...
      if (present(min_area_in)          ) min_area         = min_area_in
      if (present(min_mass_in)          ) min_mass         = min_mass_in
...
! subroutine to query the column package internal parameters
      ...
      subroutine icepack_query_parameters(   &
         ...
         kice_out, ksno_out, min_area_out, min_mass_out, &
...
!-----------------------------------------------------------------------
      ...
      real(kind=dbl_kind), intent(out), optional :: &
         min_area_out,   & ! zap residual ice below this minimum area
         min_mass_out,   & ! zap residual ice below this minimum mass
...
!autodocument_end
      ...
      if (present(min_area_out)          ) min_area_out     = min_area
      if (present(min_mass_out)          ) min_mass_out     = min_mass
...
!autodocument_end
        ...
        write(iounit,*) "  min_area   = ",min_area
        write(iounit,*) "  min_mass   = ",min_mass
        write(iounit,*) "  Cf         = ",Cf
