...
!-----------------------------------------------------------------------
      ...
      logical (kind=log_kind), public :: &
         ...
         use_atm_dust_sol = .false. , & ! if true, read in iron solubility map for dust
         restartbgc = .false.
...
! subroutine to set the column package internal parameters
      ...
      subroutine icepack_init_parameters(   &
         ...
         phi_snow_in, T_max_in, fsal_in, use_atm_dust_sol_in, &
...
!-----------------------------------------------------------------------
     ...
     character (len=*), intent(in), optional :: &
      ...
      logical (kind=log_kind), intent(in), optional :: &
         ...
         use_atm_dust_sol_in, & ! solubility fraction
         restartbgc_in,     &
...
!autodocument_end
      ...
      if (present(use_atm_dust_sol_in)  ) use_atm_dust_sol = use_atm_dust_sol_in
...
! subroutine to query the column package internal parameters
      ...
      subroutine icepack_query_parameters(   &
         ...
         modal_aero_out, use_macromolecules_out, restartbgc_out, use_atm_dust_sol_out,&
...
!-----------------------------------------------------------------------
      ...
      logical (kind=log_kind), intent(out), optional :: &
         ...
         use_atm_dust_sol_out, & ! if .true., read dust iron solubility map from file
         restartbgc_out,     &
...
!autodocument_end
      ...
      if (present(use_atm_dust_sol_out)) use_atm_dust_sol_out = use_atm_dust_sol
