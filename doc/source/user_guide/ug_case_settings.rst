...
.. csv-table:: **zbgc_nml namelist options**
   ...
   "``algal_vel``", "real", "maximum speed of algae (m/s) :cite:`Lavoie05`", "1.11e-8"
   "``alpha2max_low_diatoms``", "real", "light limitation diatoms 1/(W/m^2)", "0.3"
   "``alpha2max_low_phaeo``", "real", "light limitation phaeocystis 1/(W/m^2)", "0.2"
   "``alpha2max_low_sp``", "real", "light limitation small plankton 1/(W/m^2)", "0.17"
   ...
   "", "``default``", "constant values defined in the code", ""
   "", "``ncar``", "POP ocean forcing data", ""
   "``bgc_flux_type`` (DEPRECATED: skl bgc only)", "``constant``", "constant ice–ocean flux velocity", "``Jin2006``"
   ...
   "``ratio_Fe2N_diatoms``", "real", "algal Fe to N in mmol/mol diatoms", "0.23"
   "``ratio_Fe2N_phaeo``", "real", "algal Fe to N in mmol/mol phaeocystis", "0.7"
   "``ratio_Fe2N_sp``", "real", "algal Fe to N in mmol/mol small plankton", "0.23"
   ...
   "``R_dFe2dust``", "real", "mg/g :cite:`Tagliabue09`", "0.035"
   "``scale_bgc``", "logical", "initialize bgc scaled by salinity profile", "``.false.``"
   ...
   "``solve_zbgc``", "logical", "solve z-biogeochemistry", "``.false.``"
...
.. csv-table:: *Biogeochemical Reaction Parameters*
   :header: "Text Variable", "Variable in code", "Description", "Namelist Parameters", "units"
